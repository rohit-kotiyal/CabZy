    ...
    return (
        <>
            ...
            <button className="md:hidden fixed top-4 left-4 z-50 text-white" onClick={() => setOpen(true)}>
                <Menu className="bg-linear-to-br from-slate-800 to-blue-900 hover:cursor-pointer" size={28} />
            </button>
            ...
            <div className={`fixed md:relative top-0 left-0 h-screen w-64 bg-slate-950 text-white 
                ...
                <h1 className="text-2xl font-bold mb-10">
                    Cab<span className="text-cyan-400">Zy</span> Driv<span className="text-cyan-400">er</span>
                </h1>
